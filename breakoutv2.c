...
#define MY_MAX_BOWLPAD_SPEED  5.0f
...
void init()
{
  ...
  backdrop  = texture_load("image/GrassBlades.jpg");
...
void keyDown(SDLKey key)
{
  ...
  switch (key)
  {
    ...
    break;
    case SDLK_j:
          bowlPadSpeed += bowlPadSpeed <= MY_MAX_BOWLPAD_SPEED ? 0.1f : 0.0; 
    break;
    case SDLK_h:
          bowlPadSpeed -= bowlPadSpeed >= MIN_BOWLPAD_SPEED ? 0.1f : 0.0; 
    break;
    case SDLK_d:
          displayBD = !displayBD;
    default:
